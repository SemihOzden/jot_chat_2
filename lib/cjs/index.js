...
var OutgoingMessages = function OutgoingMessages(_ref) {
  ...
  if (question.type === 'control_datetime') {
    return React__default.createElement("div", {
      ...
      className: "sent_msg"
    }, React__default.createElement("p", null, "".concat(question.text, " Format: ").concat(question.format)), React__default.createElement("span", {
      className: "time_date"
    }, " 11:01 AM | June 9")));
    ...
    return React__default.createElement("div", {
      ...
      key: question.order
    }, question.text, React__default.createElement("br", null), _divideOptions2.map(function (item) {
      return React__default.createElement("p", {
        className: "options_P",
        key: item
  ...
  return React__default.createElement("div", {
    ...
    className: "sent_msg"
  }, React__default.createElement("p", null, question.text), React__default.createElement("span", {
    className: "time_date"
  }, " 11:01 AM | June 9")));
};
...
var YesNoMessages = function YesNoMessages(_ref) {
  ...
  if (messages.toUpperCase() === 'YES') {
    ...
    return React__default.createElement("div", null, React__default.createElement("div", {
      ...
      className: "time_date"
    }, " 11:01 AM | June 9")))), React__default.createElement("div", {
      className: "outgoing_msg"
    }, React__default.createElement("div", {
      className: "outgoing_msg_img"
    }, React__default.createElement("img", {
...
var SendFormContainer$1 = reactRedux.connect(mapStateToProps$1)(SendFormContainer);
  ...
  _createClass(MainContainer, [{
    ...
    value: function render() {
      ...
      return React__default.createElement("div", {
        ...
        className: "sent_msg"
      }, React__default.createElement("p", null, "Hello ", this.props.username.toUpperCase(), ". Welcome to JotForm Chatbot"), React__default.createElement("span", {
        className: "time_date"
      }, " 11:01 AM | June 9"))), React__default.createElement("div", {
        className: "outgoing_msg"
      }, React__default.createElement("div", {
        ...
        className: "sent_msg"
      }, React__default.createElement("p", null, "Would you like to fullfill the form?  YES OR NO ?"), React__default.createElement("span", {
        className: "time_date"
      }, " 11:01 AM | June 9"))),
      /* outgoing messages */
      ...
      }), React__default.createElement(SendFormContainer$1, {
        sendForm: this.sendForm
      })), React__default.createElement(TypeMessage$1, {
...
var MainContainer$1 = reactRedux.connect(mapStateToProps$2)(MainContainer);
...
var Login$1 = reactRedux.connect(mapStateToProps$3)(Login);

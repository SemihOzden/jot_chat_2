  ...
  _createClass(TypeMessage, [{
    ...
    value: function render() {
      if (this.props.saveFormQuestions.length === this.props.count) {
        ...
        return React.createElement("div", null, React.createElement(ReactCSSTransitionGroup, {
          transitionName: "fade",
          transitionEnter: 3000,
          transitionLeave: 3000
        }, React.createElement(WarningMessages, {
...
var OutgoingMessages = function OutgoingMessages(_ref) {
  ...
  if (question.type === 'control_datetime') {
    if (question.format === 'mmddyyyy') {
      ...
      }, "".concat(question.text, " Format: MM-DD-YYYY"))), React.createElement("span", {
        className: "time_date"
      }, " ", getHour)));
      ...
      return React.createElement("div", {
        ...
        className: "outgoing_msg_question"
      }, "".concat(question.text, " Format: DD-MM-YYYY"))), React.createElement("span", {
        className: "time_date"
      }, " ", getHour)));
      ...
      return React.createElement("div", {
        ...
        className: "outgoing_msg_question"
      }, "".concat(question.text, " Format: YYYY-MM-DD"))), React.createElement("span", {
        className: "time_date"
      }, " ", getHour)));
    }
  } else if (question.type === 'control_dropdown') {
    ...
    return React.createElement("div", {
      ...
      className: "outgoing_msg_question"
    }, question.text), React.createElement("span", {
      className: "checkMultipleSelection"
    }, "(,) for multiple selection "), React.createElement("br", null), _divideOptions2.map(function (item) {
      return React.createElement("p", {
        className: "options_P",
        key: item
...
var YesNoMessages = function YesNoMessages(_ref) {
  ...
  if (messages.toUpperCase() === 'YES') {
    ...
    return React.createElement("div", null, React.createElement("div", {
      ...
      className: "time_date"
    }, " ", getHour$1)))), React.createElement("div", {
      className: "outgoing_msg"
    }, React.createElement("div", {
      className: "outgoing_msg_img"
    }, React.createElement("img", {
    ...
    value: function render() {
      ...
      if (this.props.saveFormQuestions.length === this.props.count) {
        return React.createElement("div", {
          ...
          className: "outgoing_msg_question"
        }, " You fulfilled the form. Please click Send Form button to send the form.")), React.createElement("span", {
          className: "time_date"
        }, getHour$2)));
      }
...
var FinishMessage$1 = connect(mapStateToProps$1)(FinishMessage);
    ...
    value: function render() {
      if (this.props.sendingMessage !== '') {
        ...
        return React.createElement("div", {
          ...
          className: "outgoing_msg_question"
        }, this.props.sendingMessage)), React.createElement("span", {
          className: "time_date"
        }, getHour$3)));
      }
...
var SendFormMessage$1 = connect(mapStateToProps$2)(SendFormMessage);
  ...
  _createClass(MainContainer, [{
    ...
    value: function render() {
      ...
      return React.createElement("div", {
        ...
        className: "outgoing_msg_question"
      }, "Hello ", this.props.username.toUpperCase(), ". Welcome to JotForm Chatbot")), React.createElement("span", {
        className: "time_date"
      }, " ", getHour$4))), React.createElement("div", {
        className: "outgoing_msg"
      }, React.createElement("div", {
        className: "outgoing_msg_img"
      }, React.createElement("img", {
        ...
        className: "outgoing_msg_question"
      }, "Would you like to fullfill the form?  YES OR NO ?")), React.createElement("span", {
        className: "time_date"
      }, " ", getHour$4))),
      /* outgoing messages */
      ...
      /* Finish messages */
      React.createElement(FinishMessage$1, null),
      /* Send Form Message */
      React.createElement(SendFormMessage$1, null)), React.createElement(TypeMessage$1, {
...
var MainContainer$1 = connect(mapStateToProps$3)(MainContainer);
...
var Login$1 = connect(mapStateToProps$4)(Login);
